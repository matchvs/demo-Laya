...
var Battle = /** @class */ (function (_super) {
    ...
    //右移动
    Battle.prototype.roleMoveRight = function (tableid) {
        console.info("右移动");
    ...
    //左移动
    Battle.prototype.roleMoverLeft = function (tableid) {
        console.info("左移动");
        var role = this["roleAnimal" + tableid];
        var spritePlayer = this["Sprite_player" + tableid];
        var namePlayer = this["name_player" + tableid];
    ...
    Battle.prototype.messageParse = function (userID, msg) {
        if (msg != "" && msg.indexOf("action") >= 0) {
            ...
            if (obj.action == GameData.MSG_ACTION.BALL_MOVE) {
                ...
                if (obj.left == 1) {
                    this.roleMoverLeft(tableID_1);
                }
                else if (obj.right == 1) {
                    this.roleMoveRight(tableID_1);
                }
                else {
                ...
                this["score_Player" + tableID_1].text = obj.score;
            }
        }
    };
    /**
